# %load /kaggle/working/visualDet3D/config/config.py
...
## path
path = edict()
path.data_path = "../input/kitti-dataset" # used in visualDet3D/data/.../dataset
path.test_path = "../input/kitti-dataset" # used in visualDet3D/data/.../dataset
path.visualDet3D_path = "/kaggle/working/visualDet3D" # The path should point to the inner subfolder
path.project_path = "/kaggle/working/Stereo3D" # or other path for pickle files, checkpoints, tensorboard logging and output files.
